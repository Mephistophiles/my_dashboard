...
**Дополнение:**
- Неиспользуемый код (импорты, переменные, функции) должен быть полностью удалён, а не закомментирован.
- Комментарии вида // use ... для отключения кода запрещены.
...
**Дополнение:**
- Неиспользуемые импорты и код должны быть удалены, а не закомментированы.
- В тестах разрешается использовать имена переменных с `_`, но не оставлять закомментированный код.
